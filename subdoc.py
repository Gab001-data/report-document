...
tpl = DocxTemplate("Report_templates/subdoc_tpl.docx")

sd = tpl.new_subdoc()
#doc = Document()
p = sd.add_paragraph("This is a sub-sdument inserted into a bigger one")
p = sd.add_paragraph("It has been ")
p.add_run("dynamically").bold = True# style = "dynamic"
...
sd.add_picture("images/python_logo.png", width=Inches(1.25))
